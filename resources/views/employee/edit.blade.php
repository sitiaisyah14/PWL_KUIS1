                ...
                <form method="post" action="{{ route('employee.update', $Employee->id)}}" id="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="date_of_birth" class="form-control" id="date_of_birth" value="{{$Employee->date_of_birth}}" aria-describedby="date_of_birth">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="wages" class="form-control" id="wages" value="{{$Employee->wages}}" aria-describedby="wages">
                        </div>
